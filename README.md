...
• System sends automatic reminders such as:
...
If the information exists in the system, the chatbot answers instantly.
...
• If the chatbot cannot answer, it asks whether to forward the question
...
Admin replies normally, and the system delivers the answer to the student privately.
...
If you want, I can generate a **GitHub description**, **cover image**, or **branch structure** for your repository.
